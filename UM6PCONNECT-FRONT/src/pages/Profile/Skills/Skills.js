    ...
    return (
        <div className="box" style={{ width: "90%", margin: "20px auto", padding: "20px", border: "2px solid #ddd", borderRadius: "12px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "10px" }}>
                ...
                <AddIcon onClick={() => handleOpen(null)} style={{ cursor: "pointer", color: "#e04c2c", border: "1px solid #e04c2c", borderRadius: "8px", padding: "5px", fontSize: "30px" }} />
            </div>
                    ...
                    <div key={skill._id || index}>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "15px", marginTop: "15px" }}>
                            ...
                            <div style={{ display: "flex", gap: "10px" }}>
                                <EditIcon onClick={() => handleOpen(skill)} style={{ cursor: "pointer", color: "#e04c2c", fontSize: "24px" }} />
                                <DeleteIcon onClick={() => setDeleteSkillId(skill._id)} style={{ cursor: "pointer", color: "#e04c2c", fontSize: "24px" }} />
                            </div>
                        </div>
