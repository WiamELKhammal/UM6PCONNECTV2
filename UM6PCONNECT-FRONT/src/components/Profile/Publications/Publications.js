...
const Publications = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h4 style={{ fontWeight: "600", fontSize: "18px", color: "#d84b2b" }}>Publications</h4>
          <p style={{ fontSize: "14px", color: "#666" }}>Add your research publications to showcase your work.</p>
        </div>
        <AddIcon
          ...
          <div key={pub._id || index}>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
                ...
                >
                  <ArticleIcon style={{ color: "#555", fontSize: "30px" }} />
                </div>
                <div>
                  <p style={{ fontWeight: "500" }}>{pub.title || "Publication Title"}</p>
                  <p style={{ color: "#666" }}>{pub.authors || "Author(s)"}</p>
                  <p style={{ color: "#999" }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "15px" }}>
            ...
            <div>
              ...
              <p style={{ color: "#666" }}>Author(s)</p>
              <p style={{ color: "#999" }}>Date - Journal/Conference</p>
            </div>
          </div>
        </div>
      )}
